...
```env
# Database
DATABASE_URL=postgresql://user:[REVOKED_SECRET_REMOVED]@localhost:5433/dbname
...
```bash
# Use mc (MinIO Client)
mc alias set local http://localhost:9000 [REVOKED_SECRET_REMOVED] [REVOKED_SECRET_REMOVED]
