...
from .ffmpeg_wrapper import AspectRatio, ConversionStrategy
...
class SmartCropStub:
    ...
    def __init__(self):
        ...
        self.available_strategies = list(CropStrategy)
    ...
    async def get_crop_region(self, params: SmartCropParams) -> CropRegion | None:
        """
