...
class AESGCMCipher:
    ...
    def decrypt(self, encrypted_data: str, associated_data: str | None = None) -> str:
        """
...
def encrypt_data(data: str, associated_data: str | None = None) -> str:
    """Encrypt data using default cipher."""
    return cipher.encrypt(data, associated_data)


def decrypt_data(encrypted_data: str, associated_data: str | None = None) -> str:
    """Decrypt data using default cipher."""
    return cipher.decrypt(encrypted_data, associated_data)


def sign_webhook(payload: str, timestamp: int | None = None) -> str:
...
def create_jwt_token(payload: dict[str, Any], expires_in: int | None = None) -> str:
    """Create JWT token."""
