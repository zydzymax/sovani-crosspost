...
class TelegramAdapter:
    ...
    async def _send_single_media(self, message: TelegramMessage, correlation_id: str = None) -> TelegramSendResult:
        ...
        with with_logging_context(correlation_id=correlation_id, media_type=media_item.media_type.value):
            ...
            if media_item.file_path.startswith(('http://', 'https://')):
                ...
                files = {
                    file_field: (file_name, file_content, mime_type or "application/octet-stream")
                }
    ...
    def _generate_message_url(self, chat_id: Union[int, str], message_id: int) -> Optional[str]:
        """Generate message URL if possible."""
    ...
    async def _check_rate_limits(self, chat_id: Union[int, str]):
    ...
    async def _make_api_request(self, method: str, params: Dict[str, Any] = None, 
    ...
    async def edit_message_text(self, chat_id: Union[int, str], message_id: int, 
                              text: str, parse_mode: ParseMode = None) -> bool:
        """Edit message text."""
        try:
            params = {
                "chat_id": chat_id,
    ...
    async def update_message_status(self, post_id: str, status: str, result_data: Dict[str, Any] = None):
        ...
        logger.info(
            "Updating Telegram message status",
            post_id=post_id,
            status=status,
...
async def send_telegram_message(chat_id: Union[int, str], text: str = None,
                              media_files: List[str] = None,
                              parse_mode: ParseMode = None,
                              disable_notification: bool = False,
                              correlation_id: str = None) -> TelegramSendResult:
    """
    Send message to Telegram.
    ...
    if media_files:
        for file_path in media_files:
            ...
            media_items.append(TelegramMediaItem(
                file_path=file_path,
...
async def send_telegram_photo(chat_id: Union[int, str], photo_path: str,
                            caption: str = None, parse_mode: ParseMode = None,
                            correlation_id: str = None) -> TelegramSendResult:
...
async def send_telegram_video(chat_id: Union[int, str], video_path: str,
                            caption: str = None, thumbnail: str = None,
                            width: int = None, height: int = None,
                            duration: int = None, correlation_id: str = None) -> TelegramSendResult:
...
async def send_telegram_media_group(chat_id: Union[int, str], media_files: List[str],
                                  caption: str = None, parse_mode: ParseMode = None,
                                  correlation_id: str = None) -> TelegramSendResult:
...
async def get_telegram_chat_info(chat_id: Union[int, str]) -> Dict[str, Any]:
    """Get Telegram chat information."""
    return await telegram_adapter.get_chat(chat_id)


async def delete_telegram_message(chat_id: Union[int, str], message_id: int) -> bool:
...
async def publish_telegram_message(chat_id: Union[int, str], text: str = None,
                                 media_files: List[str] = None,
                                 parse_mode: ParseMode = None,
                                 disable_notification: bool = False,
                                 correlation_id: str = None) -> TelegramSendResult:
...
async def publish_telegram_photo(chat_id: Union[int, str], photo_path: str,
                                caption: str = None, parse_mode: ParseMode = None,
                                correlation_id: str = None) -> TelegramSendResult:
...
async def publish_telegram_video(chat_id: Union[int, str], video_path: str,
                                caption: str = None, thumbnail: str = None,
                                width: int = None, height: int = None,
                                duration: int = None, correlation_id: str = None) -> TelegramSendResult:
...
async def publish_telegram_media_group(chat_id: Union[int, str], media_files: List[str],
                                     caption: str = None, parse_mode: ParseMode = None,
                                     correlation_id: str = None) -> TelegramSendResult:
