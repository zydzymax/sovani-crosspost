...
def make_celery() -> Celery:
    ...
    celery_app.conf.update(
        ...
        task_routes={
            ...
            "app.workers.tasks.outbox.*": {"queue": "outbox", "priority": 10, "rate_limit": "20/s"},  # Highest priority
        },
...
def task_prerun_handler(sender=None, task_id=None, task=None, args=None, kwargs=None, **kwds):
    ...
    with with_logging_context(task_id=task_id):
        ...
        task_logger.info("Task started", task_name=sender.name, task_id=task_id, args=args, kwargs=kwargs)
...
def task_postrun_handler(sender=None, task_id=None, task=None, args=None, kwargs=None, retval=None, state=None, **kwds):
    ...
    with with_logging_context(task_id=task_id):
        ...
        task_logger.info(
            "Task completed", task_name=sender.name, task_id=task_id, state=state, execution_time=execution_time
        )
...
def task_success_handler(sender=None, result=None, **kwargs):
    ...
    task_logger.info("Task succeeded", task_name=sender.name, result_type=type(result).__name__ if result else None)
...
def ping():
    ...
    try:
        ...
        with celery.connection_or_acquire() as conn:
            conn.default_channel.queue_declare(queue="health_check", passive=True)
